                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <a class="btn btn-primary"
                                href="http://localhost/RMA/RESTAURANT/WEB%20Final/ajax-live-search/" role="button">
                                <h5>Restaurant</h5>
                            </a>
                ...
                <div class="col-sm-6 col-md-5 col-lg-6">
                    <div class="h-log-txt">
                        ...
                        <a class="btn btn-outline-primary"
                            href="http://localhost/RMA/USER/Class2%20Task/Class2%20Task/login.php" role="button"
                            style="font-size:25px;">Log In</a>
                ...
                <div class="col-sm-6 col-md-5 offset-md-2 col-lg-6 offset-lg-0">
                    <div class="h-reg-txt">
                        ...
                        <a class="btn btn-outline-success"
                            href="http://localhost/RMA/USER/Class2%20Task/Class2%20Task/registration_ra.php"
                            role="button" style="font-size:25px;">Registration</a>
                    </div>
                </div>
            </div>
        </div>
