...
<body>
    <?php
$target_dir = "pic/";//alocating location holding uploaded pic
...
?>
    <!--this div is for making pro pic separate. so that I can apply css and do somthing.. fieldset and legend is explaind before..-->
    <div class="photo">
        <fieldset>
