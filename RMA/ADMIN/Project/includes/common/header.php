...
<body>
    <nav>
        <div class="hfull">
            <div class="htop">
                <div class="hleft">
                    <div class="hlogo"> <img src="http://localhost/c3/Project/resources/img/logo.png" alt="logo">
                    </div>
                    <div class="hname">
                        <h2>SURJO TEC</h2>
                    </div>
                ...
                <div class="hright">
                    <div class="hcontent">
                        ...
                        if(isset($_SESSION["SuserName"]))
                        {
                            ...
                            echo" <a href='http://localhost/RMA/ADMIN/Project/view/users/logOut.php'>$log</a>";
                        }else{
                            echo" <a href='http://localhost/RMA/USER/Class2%20Task/Class2%20Task/login.php'>$log</a>";
                        }
                        ?>
