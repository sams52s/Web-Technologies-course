      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
             ...
             <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> HOME PAGE </a>
            </li>


            <li class="bold"><a href="profile.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Upload a Profile Picture </a>
            </li>
...
<div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2021 <a class="grey-text text-lighten-4" href="#" target="_blank">G1-1Resturant</a> </span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="https://github.com/NaimulHossain">Naimul HOSSAIN</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
