        ...
        <header>
            ...
            <main>
                <section class="page Restaurant">
                    ...
                    <div class="hero">
                        <img class="model-left" src="./Css/Img/funny_restaurant_poster_design_vector_533827-right.jpg"
                            alt="Restaurant">
                        <img class="model-right" src="./Css/Img/funny_restaurant_poster_design_vector_533827.jpg"
                            alt="Restaurant">
