        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style=" font-size: 20px;">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost/RMA/ADMIN/Project/view/about.php">About <span
                            class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item" data-toggle="tooltip" data-placement="top" title="Some Answer of your questions">
                    <a class="nav-link" href="http://localhost/RMA/ADMIN/Project/view/users/admin.php">ADMIN</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
                ...
                <li class="nav-item">
                    <a class="nav-link"
                        href="http://localhost/Final%20project/Project/view/restaurant.php">Restaurant</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/RMA/ADMIN/Project/view/">Home</a>
                </li>
