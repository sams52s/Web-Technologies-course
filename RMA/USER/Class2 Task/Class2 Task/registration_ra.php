        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td><input class="inp" id="location" type="text" name="location" onkeyup="validateLocation(this)">
                    </td>
                    <td class="err-msg" colspan="3"></td>
                </tr>
                <!-- <tr>
                ...
                <tr>
                    ...
                    <td><input class="inp" id="nid" type="text" name="nid" onkeyup="validateNID(this)"></td>
                    <td class="err-msg" colspan="3"></td>
                </tr>
                <tr>
                    <td><label for="password">Password</label></td>
                    <td><input class="inp" id="password" type="password" name="password"
                            onkeyup="validatePassword(this)"></td>
                    <td class="err-msg" colspan="3"></td>
                </tr>
                <tr>
                    <td><label for="cpassword">Confirm Password</label></td>
                    <td><input class="inp" id="cpassword" type="password" name="cpassword"
                            onkeyup="validateCPassword(this)"></td>
                    <td class="err-msg" colspan="3"></td>
                </tr>
                <!-- <tr>
                ...
                <tr>
                    ...
                    <td><button class="btn" id="regsubmit" type="submit" name="registration">Registration</button></td>
